...
<![%l10n-th;[
<!ENTITY dbl1th
  PUBLIC "-//Norman Walsh//DOCUMENT DocBook Stylesheet Localization//TH"
         "../common/dbl1th.dsl" CDATA DSSSL>
]]>
<!ENTITY dbl1th
  PUBLIC "-//Norman Walsh//DOCUMENT DocBook Stylesheet Null Localization//EN"
         "../common/dbl1null.dsl" CDATA DSSSL>
...
<style-specification id="docbook"
   use="af ca cs da de el en es et fi fr hu id it ja ko nl no pl pt ptbr ro ru sk sl sr sv th tr zhcn zhtw param dblib">
